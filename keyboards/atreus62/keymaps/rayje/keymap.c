...
[_DEFAULT] = { /* qwerty */
		...
		{ KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,    KC_DELT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RBRC },
        { KC_ESC,  KC_LGUI, KC_LALT, KC_GRV,  MO(_NAV), KC_LGUI, KC_BSPC,  KC_SPC,  KC_EQL,  KC_MINS, KC_QUOT, KC_ENT,  KC_RGUI }
},
