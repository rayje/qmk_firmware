...
[_QWERTY] = { /* Qwerty */
  ...
  {KC_Z,    KC_X,    KC_C,  KC_V,    KC_B,  KC_LSFT,  KC_EQL,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH},
  {KC_TAB,  KC_LGUI, MO(4), LOWER, KC_BSPC, KC_LALT,  KC_ENT,  KC_SPC, RAISE,  KC_VOLD, KC_VOLU, MO(6)}
},
/* Colemak
 * ,----------------------------------------------------------------------------------------.
...
[_LOWER] = {
  ...
  {CTL_A,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TILD, KC_PIPE, KC_F6,   KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC},
  {KC_F7,   KC_F8,   KC_F9,   CTL_V,   KC_F11,  KC_TRNS, KC_BSLS, KC_F12,  KC_MINS, KC_EQL,  KC_UP,   _______},
...
[_TOUCHCURSOR] = {
  ...
  {_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_6,    KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, _______},
  {_______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  _______, _______, _______, _______},
