...
## Custom Building (rayje)

Run the following command from the same directory as this readme.

```
rm ../../atreus_rayje.hex; KEYMAP=rayje make TEENSY2=yes rayje; cp ../../atreus_rayje.hex .
teensy_loader_cli -w -mmcu=atmega32u4 atreus_rayje.hex
```

>>>>>>> Update layout with missing items
