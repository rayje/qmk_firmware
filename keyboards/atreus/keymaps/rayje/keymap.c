 ...
 * +------+------+------+------+------| | Ctrl |   |  Alt | +------+------+------+------+------|
 * |  Esc |  Gui |  Tab |  _FN | Bksp | |  Del |   | Enter| |Sp/_NU|  _EX |   -  |  Alt |   =  |
 * `----------------------------------' `------'   `------' `----------------------------------'
 */
[_CO] = KEYMAP(
 ...
 * +------+------+------+------+------|                     +------+------+------+------+------|
 * | Tab  |      |      |      |      |                     | Vol ^| MLeft| MDown|MRight|      |
 * +------+------+------+------+------|                     +------+------+------+------+------|
 * | Shift|      |      |      |      | ,------.   ,------. | Vol v|Whl Up|      |Whl Dn|      |
 * +------+------+------+------+------| |      |   |      | +------+------+------+------+------|
 * |      |      |      |      |      | |      |   |      | |LClick|MClick| _CO  |  _GA | RESET|
 * `----------------------------------' `------'   `------' `----------------------------------'
 *
 */
[_MS] = KEYMAP( 
  KC_CAPS, _______, _______, KC_MSTP, KC_MPLY,                   KC_MUTE, KC_BTN1, KC_MS_U, KC_BTN2, _______,
  KC_TAB,  _______, _______, _______, _______,                   KC_VOLU, KC_MS_L, KC_MS_D, KC_MS_R, _______,
  KC_LSFT, _______, _______, _______, _______,                   KC_VOLD, KC_WH_U, _______, KC_WH_D, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
 ...
 *
 * ,-----------------------------------.                     ,----------------------------------.
 * |CmdTab |CMSTab|      |      |      |                     |Insert| Home |  Up  | End  | Bksp |
 * +-------+------+------+------+------|                     +------+------+------+------+------|
 * |SCtlTab|CtlTab|      |      |      |                     | PgUp | Left | Down |Right |      |
 * +-------+------+------+------+------|                     +------+------+------+------+------|
 * |Shift  |      |      |      |      | ,------.   ,------. | PgDn |      |      |      |      |
 * +-------+------+------+------+------| |      |   |      | +------+------+------+------+------|
 * |       |      |      |      |      | |      |   |      | |      |      |      |      |      |
...
[_TC] = KEYMAP(
  ...
  SFCTL_TAB, LCTL_TAB,  _______, _______, _______,                   KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT, _______,
  KC_LSFT,   _______,   _______, _______, _______,                   KC_PGDN, _______, _______, _______, _______,
  _______,   _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_ADJ] = KEYMAP(
  ...
  KC_CAPS, KC_F11,  KC_F12,  _______, _______,                   KC_VOLU, _______, _______, _______, _______,
  KC_LSFT, _______, _______, _______, _______,                   KC_VOLD, _______, _______, _______, RESET,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
};
